...
function headerScroll() {
  if (window.innerWidth < 1440) {
    document.removeEventListener("scroll", headerScrolling);
    return;
  } else {
...
document
  .querySelector(".portfolio__btn-right")
...
function rollSlider() {
  if (count > 0) {
    btnLeft
      .querySelector(".portfolio__svg--active")
      .classList.remove("portfolio__none");
    btnLeft
      .querySelector(".portfolio__svg--not-active")
      .classList.add("portfolio__none");
  }
...
function rollSliderCliennts() {
  if (countClients > 0) {
    btnLeftClients
      .querySelector(".clients__svg--active")
      .classList.remove("clients__none");
    btnLeftClients
      .querySelector(".clients__svg--not-active")
      .classList.add("clients__none");
  }
